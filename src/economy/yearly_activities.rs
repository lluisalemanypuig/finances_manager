...
impl YearlyActivities {
    ...
    pub fn iter_expenses(&self) -> std::slice::Iter<'_, MonthlyActivities<Expense>> {
        self.m_expenses.iter()
    }
    ...
    pub fn get_expenses(&self) -> &MonthlyActivitiesCollection<Expense> {
        &self.m_expenses
    }
    ...
    pub fn iter_incomes(&self) -> std::slice::Iter<'_, MonthlyActivities<Income>> {
        self.m_incomes.iter()
    }
    ...
    pub fn get_incomes(&self) -> &MonthlyActivitiesCollection<Income> {
        &self.m_incomes
    }
    ...
    pub fn as_ref(&self) -> &YearlyActivities {
        self
    }
